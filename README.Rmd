...
It even deploys to shinyapps.io (see [here](https://shiny.rstudio.com/articles/shinyapps.html) for more info, provide the correct information, and **provided you install `shinyngs` from devtools, rather than Conda**.
