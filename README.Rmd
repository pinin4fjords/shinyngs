...
This is designed to take a regular file complement and produce an app.R. It even deploys to shinyapps.io (see [here](https://shiny.rstudio.com/articles/shinyapps.html) for more info, provide the correct information, and **provided you install `shinyngs` from devtools, rather than Conda**.

Without the shinyapps deployment, you can still start the resulting app locally, by executing the `app.R` resulting from the above command.
