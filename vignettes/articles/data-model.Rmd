...
complete object you could hand straight to `prepareApp()`.
...
![Both the CLI and direct R construction converge on an ExploratorySummarizedExperiment(List), which prepareApp() turns into a Shiny app](img/dataflow.svg)
