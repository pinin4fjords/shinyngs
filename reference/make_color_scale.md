...
``` r
make_color_scale(ncolors, palette = COLORBLIND_PALETTE_NAME)
```
...
``` r
make_color_scale(10)
#> make_color_scale: 10 categories requested, more than the 8 colours in shinyngs' colour-blind-safe palette. Interpolating additional shades, which will be harder to tell apart than the base palette.
