...
- [`geneModelPlot()`](https://pinin4fjords.github.io/shinyngs/reference/geneModelPlot.md)
...
- [`unpack.list()`](https://pinin4fjords.github.io/shinyngs/reference/unpack.list.md)
  : Unpack a list to the environment. Handy when many reactive functions
  are returned by a call to a module's server function
