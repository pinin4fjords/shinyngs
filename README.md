...
-   A variety of single and multiple-panel Shiny applications- currently heatmap, pca and a simple table with an RNA-seq app currently being ported from non-modularised code.
