        ...
        withProgress(message = "Rendering row selection", value = 0, {
            ...
            gene_select <-
              list(
                ...
                # ),
                conditionalPanel(
                  condition = paste0("input['", ns("geneSelect"), "'] == 'metadata_pick' "),
                  labelselectfieldInput(ns("gene_label_pick"))
                ),
                conditionalPanel(
                  condition = paste0("input['", ns("geneSelect"), "'] == 'metadata_list' "),
