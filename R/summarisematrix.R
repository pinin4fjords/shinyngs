...
summarisematrixInput <- function(id, allow_none = TRUE, select_summary_type = TRUE) {
    ...
    field <- inlineField(selectInput(ns("summaryType"), NULL, c(summaryoptions, Mean = "colMeans", `Geometric mean` = "colGeomMeans", 
        Median = "colMedians"), selected = "none"), label = "Average type")
