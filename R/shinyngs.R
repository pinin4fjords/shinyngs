...
#' of an \code{ExploratorySummarizedExperiment}} \item{modal}{uses Shiny's
#' \code{modalDialog()} to create overlaid text for the current panel which
#' displays when a link is clicked}
