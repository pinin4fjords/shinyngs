...
volcanoplot <- function(input, output, session, eselist) {
    ...
    callModule(scatterplot, "volcano", getDatamatrix = volcanoTable, title = paste("Volcano plot for contrast", getSelectedContrastNames(), sep = "<br />"), allow_3d = FALSE, getLabels = volcanoLabels, 
