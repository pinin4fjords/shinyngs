...
test_that("interactive_illumina_control_probes draws one line trace per QC group, averaged across matching probes", {
  fixture <- make_control_fixture()

  built <- plotly::plotly_build(interactive_illumina_control_probes(fixture$control_annotation, fixture$controls))
...
test_that("interactive_illumina_control_probes averages multiple probes matching the same QC group", {
  fixture <- make_control_fixture()
...
test_that("interactive_illumina_control_probes respects a custom sample display order", {
  fixture <- make_control_fixture()

  built <- plotly::plotly_build(interactive_illumina_control_probes(fixture$control_annotation, fixture$controls, sample_order = c("sample3", "sample1", "sample2")))
